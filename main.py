...
class SmartCourierSimulator:
    ...
    def setup_ui(self):
        ...
        self.speed_scale = tk.Scale(self.control_frame, from_=1, to=50, orient=tk.HORIZONTAL)
    ...
    def run_delivery(self):
        ...
        self.turn_towards(self.source)  # ← Menghadap ke bendera source
        ...
        self.turn_towards(self.destination)  # ← Menghadap ke bendera tujuan
        self.has_package = False
